...
namespace QuickFix
{
    ...
    public class FileLog : ILog, System.IDisposable
    {
        ...
        private System.IO.FileStream messageFS;
        private System.IO.FileStream eventFS;
        ...
        private void Init(string fileLogPath, string prefix)
        {
            ...
            messageFS=new System.IO.FileStream(messageLogFileName_,System.IO.FileMode.OpenOrCreate,System.IO.FileAccess.Write,System.IO.FileShare.ReadWrite);
            eventFS = new System.IO.FileStream(eventLogFileName_, System.IO.FileMode.OpenOrCreate, System.IO.FileAccess.Write, System.IO.FileShare.ReadWrite);
            messageLog_ = new System.IO.StreamWriter(messageFS);
            eventLog_ = new System.IO.StreamWriter(eventFS);
        ...
        public void Dispose()
        {
            ...
            if (messageFS != null) { messageFS.Close(); messageFS.Dispose(); }
            if (eventFS != null) { eventFS.Close(); eventFS.Dispose(); }
