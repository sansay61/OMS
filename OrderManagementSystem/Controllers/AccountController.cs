...
namespace OrderManagementSystem.Controllers
{
    ...
    public class AccountController : BaseController
    {
        ...
        public CUserManager UserManager { get; private set; }
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            ...
            if (ModelState.IsValid)
            {
                var user = new CUser() { UserName = model.UserName };
        ...
        private async Task SignInAsync(CUser user, bool isPersistent)
        {
            ...
            claim.AddClaim(new Claim(ClaimTypes.Name,user.UserName, ClaimValueTypes.String));
            ...
            {
                string usrroles = "";
                var roles = UserManager.GetRoles<CUser, int>(user.Id);
                ...
                claim.AddClaim(new Claim(ClaimsIdentity.DefaultRoleClaimType, usrroles, ClaimValueTypes.String));
            }
